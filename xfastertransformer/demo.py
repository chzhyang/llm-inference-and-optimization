...
bc_model_v = "/models/baichuan2-13b-xft-fp16"
qw="/home/ge/models/qwen-7b-chat-xft"
qw_v="/models/qwen-7b-chat-xft"
llama="/home/ge/models/llama2-7b-xft"
llama_v="/app/llama2-7b-xft"
token_path=llama_v
model_path=llama_v
# bc_pmt="登鹳雀楼->王之涣\n夜雨寄北->"
parser = argparse.ArgumentParser()
parser.add_argument("-t", "--token_path", type=str, default=token_path, help="Path to token file")
parser.add_argument("-m", "--model_path", type=str, default=model_path, help="Path to model file")
...
parser.add_argument("--temperature", help="value used to modulate next token probabilities.", type=float, default=0.7)
parser.add_argument("--top_p", help="retain minimal tokens above topP threshold.", type=float, default=0.7)
